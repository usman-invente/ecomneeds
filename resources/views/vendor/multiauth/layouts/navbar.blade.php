        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span  id="count-notif" class="badge badge-danger navbar-badge">{{Auth::user()->unreadnotifications->count()}}</span>
                </a>
                        ...
                        @foreach(Auth::user()->unreadnotifications as $notification)
                            <div id="append_notif">
                                ...
                                <a href="#" class="dropdown-item">
                                    <!-- Message Start -->
                                    <div class="media">
                                        <img src="{{$notification->data['order']['src']}}"
                                             alt="User Avatar"
                                             class="img-size-50 mr-3 img-circle">
                                        <div class="media-body">
                                            <p class="dropdown-item-title">
                                                You have received new order
                                                from {{$notification->data['order']['name']}}
...
{{--            </li>--}}
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            ...
            <span class="brand-text font-weight-light">ECOMNEEDS</span>
        </a>
        ...
        <div class="sidebar">
           ...
           with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.showusers')}}" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.showorders')}}" class="nav-link">
                            <i class="nav-icon fas fa-user"></i>
                            <p>
                                Orders
